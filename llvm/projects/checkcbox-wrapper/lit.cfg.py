...
checkcbox_obj_root = getattr(config, 'checkcbox_obj_root', None)

if checkcbox_obj_root is not None:
    config.test_exec_root = os.path.join(checkcbox_obj_root)
...
config.substitutions.append(
    ('%checkcbox_target_flags', config.checkcbox_target_flags))
# checkcbox_rununder is the target-specific device prepended to each execution
# RUN line of lit.
config.substitutions.append(
    ('%checkcbox_rununder', config.checkcbox_rununder))
