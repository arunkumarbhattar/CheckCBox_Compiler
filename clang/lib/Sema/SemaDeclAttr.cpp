...
static void handleTaintedAttr(Sema &S, Decl *D, const ParsedAttr &Attrs) {
  if (hasDeclarator(D)) return;
    D->addAttr(::new (S.Context) TaintedAttr(S.Context, Attrs));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  case ParsedAttr::AT_NoReturn:
    ...
    break;
  case ParsedAttr::AT_Tainted:
    handleTaintedAttr(S, D, AL);
    break;
