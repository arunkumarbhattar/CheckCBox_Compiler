...
//
//===----------------------------------------------------------------------===//
// This class contains all the stats related to the conversion computed by CheckMate.
//===----------------------------------------------------------------------===//

#ifndef LLVM_CLANG_CheckMate_CheckMateSTATS_H
#define LLVM_CLANG_CheckMate_CheckMateSTATS_H
...
#endif // LLVM_CLANG_CheckMate_CheckMateSTATS_H
