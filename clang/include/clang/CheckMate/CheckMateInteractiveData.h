...
//===----------------------------------------------------------------------===//
//
// Data structures used to communicate results of CheckMate interactive mode
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_CLANG_CheckMate_CheckMateINTERACTIVEDATA_H
#define LLVM_CLANG_CheckMate_CheckMateINTERACTIVEDATA_H
...
#endif // LLVM_CLANG_CheckMate_CheckMateINTERACTIVEDATA_H
