...
// (`bounds(__CheckMate_lower_bound_p, __CheckMate_lower_bound_p + n)`), an
...
// bound, `__CheckMate_lower_bound_p` must also be updated to be equal to `q`.
//===----------------------------------------------------------------------===//

#ifndef LLVM_CLANG_CheckMate_LOWERBOUNDASSIGNMENT_H
#define LLVM_CLANG_CheckMate_LOWERBOUNDASSIGNMENT_H
...
//     q = p;
// becomes
//     __CheckMate_lower_bound_q = p, q = __CheckMate_lower_bound_q;
...
#endif // LLVM_CLANG_CheckMate_LOWERBOUNDASSIGNMENT_H
