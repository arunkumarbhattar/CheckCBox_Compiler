...
#ifndef LLVM_CLANG_CheckMate_CONSTRAINTVARIABLES_H
#define LLVM_CLANG_CheckMate_CONSTRAINTVARIABLES_H

#include "clang/CheckMate/Constraints.h"
#include "clang/CheckMate/MultiDecls.h"
#include "clang/CheckMate/OptionalParams.h"
...
// clang/include/clang/CheckMate/OptionalParams.h. Use the MKSTRING_OPTS macro to
...
public:
  ...
  // any changes made by CheckMate and is suitable to insert during rewriting.
  //
  ...
  // By default, CheckMate allows itypes to be re-solved arbitrarily. But in several
  // cases, we need to restrict itype re-solving; this function applies those
  // restrictions. (It isn't needed for fully checked types because CheckMate doesn't
...
public:
  ...
  //      by CheckMate. If this is null, then the type will be reconstructed from QT.
...
#endif // LLVM_CLANG_CheckMate_CONSTRAINTVARIABLES_H
