...
#ifndef LLVM_CLANG_CheckMate_AVARGRAPH_H
#define LLVM_CLANG_CheckMate_AVARGRAPH_H
...
template <> struct GraphTraits<AVarGraph> {
  ...
  // See clang/doc/checkedc/CheckMate/clang-tidy.md#names-referenced-by-templates
...
#endif // LLVM_CLANG_CheckMate_AVARGRAPH_H
